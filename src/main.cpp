...
#if defined(NDEBUG)
# error "BuzzCoin cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 188;
unsigned int nStakeMinAge = 8 * 60 * 60; // 6 hours
...
#ifdef ENABLE_WALLET
// BuzzCoin: attempt to generate suitable proof-of-stake
