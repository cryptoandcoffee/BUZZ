    ...
    fCapsLock(false)
{
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ...
            setWindowTitle(tr("Encrypt wallet") + ", v3.2");
            break;
        case UnlockStaking:
        ...
        case Unlock: // Ask passphrase
            ...
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Unlock wallet") + ", v3.2");
            break;
        case Decrypt:   // Ask passphrase
            ...
            ui->passLabel3->hide();
            ui->passEdit3->hide();
            setWindowTitle(tr("Decrypt wallet") + ", v3.2");
            break;
        case ChangePass: // Ask old passphrase + new passphrase x2
            setWindowTitle(tr("Change passphrase") + ", v3.2");
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         "<qt>" + 
                                         tr("BuzzCoin will close now to finish the encryption process. "
