...
extern int64_t AmountFromValueNonRounded(const json_spirit::Value& value);
...
extern json_spirit::Value getblocksbynumber(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getblockhashbynumbers(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getblockstats(const json_spirit::Array& params, bool fHelp);
